...
// Import your image
import backgroundImage1 from '../images/alarm1.jpg';
import backgroundImage2 from '../images/alarm4.jpg';
import backgroundImage3 from '../images/alarm3.jpg';
import backgroundImage4 from '../images/alarm6.jpg';
import logo from '../images/alarm5.jpg';
    ...
    <div>
      ...
      >
        <Toolbar style={{ padding: "0 24px", justifyContent: "space-between" }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "center", flexGrow: 1 }}>
            ...
            >
              ...
              <Button
                ...
                sx={{
                  mx: 2,
                  border: "2px solid #1fc733ff",
                  borderRadius: "30px",
                  padding: "10px 20px",
                  backgroundColor: "#1fc733ff",
                  color: "#fff",
                  transition: "0.3s",
                  "&:hover": {
                    background: "linear-gradient(to right, #313deaff, #4d5fd5ff)",
                    transform: "scale(1.05)",
                  },
                }}
              >
          ...
          <Box sx={{ display: "flex", alignItems: "center" }}>
            ...
            <IconButton
              sx={{
                backgroundColor: "#0f8e13ff",
                color: "#fff",
                "&:hover": { backgroundColor: "#261dc7ff" },
              }}
            >
              <Search />
            </IconButton>
      ...
      >
        ...
        >
          ...
          >
            Alarm Management System SLT Mobitel
          </Typography>
          <Typography
            variant="h4"
            sx={{
          ...
          >
            DIGITALY READY FOR A SYSTEM CHANGE
          </Typography>
        </Box>
        ...
        <Grid container alignItems="center" justifyContent="center">
          ...
          >
            ...
            <Typography variant="body1" color="textSecondary">
              At SLT Mobitel, we specialize in delivering an intelligent and efficient Alarm Management System designed to streamline network monitoring and incident management. 
              Our platform simplifies real-time alarm detection, fault management, and system performance tracking, ensuring that network issues are resolved swiftly and seamlessly.
              With a focus on automation, real-time notifications, and data-driven insights, we are committed to enhancing network reliability, improving operational efficiency, and minimizing downtime. 
              By integrating advanced monitoring tools, we enable the SLT Mobitel team to proactively manage network alarms and maintain uninterrupted connectivity for users across Sri Lanka.
              Our dedicated team ensures that every feature of the Alarm Management System is optimized for ease of use, performance, and scalability, making it the ideal solution for telecom network management. 
              Through continuous innovation, we strive to maintain SLT Mobitel’s commitment to service excellence and ensure that every network operation is smooth, efficient, and responsive.
            </Typography>
          </Grid>
        </Grid>
      </Box>
            ...
            <List>
              ...
              <ListItem>
                ...
                <ListItemText
                  ...
                  secondary="Lotus Road,Colombo 01."
                />
              </ListItem>
              {/* Email */}
              <ListItem>
              ...
              <ListItem>
                ...
                <ListItemText primary="Call Us" secondary="Dial 1212 ( Toll-free) or +94 (0) 712755777" />
              </ListItem>
              {/* Office Hours */}
              <ListItem>
                <ListItemIcon>
                ...
                <ListItemText
                  primary="Our Timing"
                  secondary="Mon - Sun: 8:30 AM - 16:30 PM"
                />
              </ListItem>
            </List>
          </Grid>
          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} sm={4}>
              ...
              <Typography
                ...
                sx={{ marginTop: "10px" }}
              >
                Dial 1212 ( Toll-free) or +94 (0) 712755777
